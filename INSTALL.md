...
and can be called with:
    ...
    java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i -auto
...
* `java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i -auto -preview22` - enables preview features for Java 22 release.
* `java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i -auto -preview23` - enables preview features for Java 23 release.
* `java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i -auto -preview24` - enables preview features for Java 24 release.
* `java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i -auto -preview25` - enables preview features for Java 25 release.
* `java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i -auto -preview26` - enables preview features for Java 26 release.
...
An example of interactive installer mode:
    ...
    shell: java -jar ./rapaio-jupyter-kernel-3.0.4.jar -i
    ...
    Select display name (default 'Java (rjk 3.0.4)'):
    ...
    "java",
    "-jar",
    "/home/ANT.AMAZON.COM/tutuianu/.local/share/jupyter/kernels/rapaio-jupyter-kernel/rapaio-jupyter-kernel-3.0.4.jar",
    "{connection_file}"
    ],
