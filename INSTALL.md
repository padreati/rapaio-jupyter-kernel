...
and can be called with:
    ...
    java -jar ./rapaio-jupyter-kernel-1.0.1.jar -i -auto
...
An example of interactive installer mode:
    ...
    shell: java -jar ./rapaio-jupyter-kernel-1.0.1.jar -i
    ...
    kernel.json:
    {
        "argv": [
            ...
            "-jar",
            "/home/ANT.AMAZON.COM/tutuianu/.local/share/jupyter/kernels/rapaio-custom-kernel/rapaio-jupyter-kernel-1.0.1.jar",
            "{connection_file}"
        ],
